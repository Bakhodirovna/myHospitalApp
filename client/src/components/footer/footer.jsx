    ...
    <div className='footer'>
                ...
                <div className="footer__box">
                        <div className='footer__box__info'>
                            {/* <NavLink className="footer__box__logo" to="/">
                                <img className='footer__box__logo__img' src="http://medix.acrothemes.com/wp-content/themes/medix/images/logo.png" alt="" />
                            </NavLink> */}
                        ...
                        <div className='footer__box__information'>
                            ...
                            <ul className='footer__box__list'>
                                {/* <li>
                                    <NavLink className='footer__box__list__item' to='/'>Home</NavLink>
                                </li> */}
                                <li>
